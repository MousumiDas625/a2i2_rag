...
def _build_iql_rag_prompt(
    ...
    instruction = (
        ...
        "IMPORTANT: Only apply the strategy if it fits the resident's stated "
        "concern. If the strategy suggests something the resident has NOT raised "
        "(e.g., offering transport when they have not mentioned needing it, "
        "challenging preparations when they have not mentioned any), skip "
        "that element and instead directly address what the resident actually said.\n\n"
        "RULES:\n"
