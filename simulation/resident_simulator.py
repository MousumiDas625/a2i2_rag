...
def _build_resident_prompt(
    ...
    system_block = (
        ...
        f"Stay completely in character as {display_name} throughout the "
        "conversation.\n\n"
        "Rules for your reply:\n"
        "  1. Reply ONLY as the Resident — do NOT include any role label.\n"
        "  2. 1–3 natural, conversational sentences.\n"
        "  3. Do NOT repeat the operator's words back verbatim.\n"
        "  4. Show realistic emotions: hesitation, doubt, concern — or "
        "agreement if persuaded."
    )
